...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sell.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SELL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SELL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SELL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SELL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SELL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SELL actions', async () => {
      const expectedActions = [
        {
